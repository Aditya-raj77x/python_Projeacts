...
def OnClick(event):
    ...
    if secret_number==buttonText:
        ...
        answer_label.config(text="wrong choice bhai")
        StartGame()

#GUI COMPONENTS
title_lable=Label(root,text="Guess the Number",font=("Helvetical 12"),pady=8,justify="center")
button_one=Button(root,font=("Helvetical 15"),text="00",width=6,pady=15,bg="palegreen")
button_two=Button(root,font=("Helvetical 15"),text="00",width=6,pady=15,bg="skyblue")
button_three=Button(root,font=("Helvetical 15"),text="00",width=6,pady=15,bg="coral")
...
title_lable.grid(row=0,column=0,columnspan=3)
